...
const socialLinks = [
  {
    ...
    subText: "on WhatsApp",
    icon: WhatsApp,
    url: "https://chat.whatsapp.com/LItcAtlapn7CSAqvhJiGSq",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@rizkijlian_",
    icon: Instagram,
    url: "https://www.instagram.com/rizkijlian_?igsh=MTlqNzdjZXgzcTZjYg%3D%3D&utm_source=qr",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@Rizki Julian Syaputra",
    icon: Youtube,
    url: "http://www.youtube.com/@rizkijuliansyaputra6995",
    color: "#FF0000",
  ...
  },
  {
    ...
    url: "https://www.tiktok.com/@varsyyy17?is_from_webapp=1&sender_device=pc",
    color: "black",
